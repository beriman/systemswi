...
<activation critical="MANDATORY">
  ...
  <menu>
    ...
    <item cmd="N8 or fuzzy match on n8n" action="Load and execute directive from {project-root}/directives/n8n-integration-bmad-master.md for n8n MCP operations">[N8] n8n Workflow Manager</item>
