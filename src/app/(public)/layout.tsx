...
export default function PublicLayout({
    ...
    return (
        <div className="min-h-screen bg-background">
                ...
                <div className="container mx-auto px-4">
                    <div className="flex h-16 items-center justify-between">
                        ...
                        <nav className="hidden md:flex items-center gap-1">
                            ...
                            <Link
                                href="/login"
                                className="ml-2 bg-accent text-accent-foreground px-4 py-2 rounded-lg text-sm font-medium hover:bg-accent/90 transition-colors"
                            >
                                Login
                            </Link>
                        </nav>
                    ...
                    {mobileMenuOpen && (
                        <div className="md:hidden border-t py-4 space-y-1">
                            ...
                            <Link
                                href="/login"
                                className="block mx-4 mt-4 bg-accent text-accent-foreground px-4 py-3 rounded-lg text-sm font-medium text-center"
                                onClick={() => setMobileMenuOpen(false)}
                            >
                                Login
                            </Link>
            ...
            {/* Footer */}
            <footer className="border-t bg-muted/50 py-16 mt-0">
                <div className="container mx-auto px-4">
                    <div className="grid gap-8 md:grid-cols-4">
                        ...
                        <div className="space-y-4">
                            ...
                            <p className="text-sm text-muted-foreground">
                                Membangun Ekosistem Wewangian Nusantara sejak 2021
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            <ul className="space-y-2 text-sm text-muted-foreground">
                                <li>
                                    <a href="mailto:sensasiwangi.id@gmail.com" className="hover:text-foreground flex items-center gap-2">
                                        <span>📧</span> sensasiwangi.id@gmail.com
                                    </a>
                                </li>
                                <li>
                                    <a href={SOCIAL_LINKS.whatsapp} target="_blank" rel="noopener" className="hover:text-foreground flex items-center gap-2">
                                        <span>📱</span> +62 811-855-6688
                                    </a>
                                </li>
