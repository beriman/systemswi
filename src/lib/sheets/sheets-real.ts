...
export const SHEETS: Record<string, { range: string; description: string }> = {
  ...
  MonthlyGcgReport:  { range: "Monthly_GCG_Report!A1:N1000",     description: "Monthly TARIF/GCG summary log for shareholder reporting readiness" },
  ...
  ExpenseSubmissions:{ range: "Expense_Submissions!A1:V1000",    description: "Expense submissions dengan approval flow + GCG + vendor fields" },
